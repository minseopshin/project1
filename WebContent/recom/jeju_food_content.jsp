...
<%	JejuFoodDao jdao = new JejuFoodDao(); 
	JejuFoodDto jdto = jdao.jeju_food_content(request);
	ArrayList<JejuFoodDto> jlist = jdao.jeju_food_photo(request);
...
<body>
	...
	<div id="sub" style="margin-left:-250px;margin-bottom:100px;" >
		...
		<div id="main" >
			...
			<img class="photo1" style="margin-top:30px;" src="food_photo/${jdto.title}/${jpdto.photo}" width="150" height="120">
			</c:forEach>
		</div>
	...
	<div style="margin-top:70px;"><input type="button" class="submit_form2" onclick="location='jeju_list.jsp?menu=food'" value="목록으로"></div>
