...
<%	JejuPlaceDao jdao = new JejuPlaceDao(); 
	JejuPlaceDto jdto = jdao.jeju_place_content(request);
	ArrayList<JejuPlaceDto> jlist = jdao.jeju_place_photo(request);
...
<body>
	...
	<div id="sub" style="margin-left:-250px;margin-bottom:100px;" >
		...
		<div id="main" >
			...
			<img class="photo1" style="margin-top:30px;" src="place_photo/${jdto.title}/${jpdto.photo}" width="150" height="120">
			</c:forEach>
		</div>
	...
	<div style="margin-top:70px;"><input type="button" class="submit_form2" onclick="location='jeju_list.jsp?menu=place'" value="목록으로"></div>
