...
<body>
	...
	<input type="button" class="submit_form4" onclick="password_check()" value="확인하기">
	
	<div id="ok"></div>
	<div id="update_delete" style="display:none;">
		<input type="button" class="submit_form5" onclick="location='reserve_join_update.jsp?id=${id}'" value="수정">
		<input type="button" class="submit_form5" onclick="location='reserve_join_cancel.jsp?id=${id}'" value="취소">
	</div>
	<div style="padding-top:50px;">
	<input type="button" onclick="location='reserve_join_check_content.jsp?id=${id}'" class="submit_form2" value="돌아가기">
	</div>
