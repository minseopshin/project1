...
%>
  <form method="post" action="pwd_search_ok.jsp">
	 ...
	 <caption style="padding-bottom:30px"> 비밀번호 찾기 </caption>
      <tr>
        <td> <input type="text" name="userid" class="text_form2" placeholder="아이디"> </td>
      </tr>
      <tr>
    ...
    <c:if test="${chk == 1}">
      <tr>
        <td style="color:red"> 아이디, 이메일, 전화번호를 다시 확인해주세요. </td>
      </tr>
    </c:if>
      <tr>
        <td> <input type="submit" class="submit_form2" value="비밀번호 찾기" > </td>
      </tr>  
    </table>
